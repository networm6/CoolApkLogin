...
public class UserSave {
    ...
    public void updateToSave () {
        SharedPreferences.Editor editor = mcon.getSharedPreferences("coolapkdata", Context.MODE_PRIVATE).edit();
    ...
    public UserSave (Context in) {
		mcon=in;
        SharedPreferences preferences = mcon.getSharedPreferences("coolapkdata", Context.MODE_PRIVATE);
